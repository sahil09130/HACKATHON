...
const PriorityList = () => {
    ...
    useEffect(() => {
        axios.get('http://localhost:5002/patient-priority')
    ...
    return (
        <div className="container">
            ...
            <div>Sorted in terms of highest to lowest chances of having skin cancer</div>
            <ul className="list">
                {priorityList && priorityList.map((priority, index) => (
